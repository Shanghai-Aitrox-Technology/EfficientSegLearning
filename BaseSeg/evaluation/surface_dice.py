...
if __name__ == '__main__':
    gt = np.random.randint(0, 2, (64, 64, 64))
    predict = np.random.randint(0, 2, (64, 64, 64))
    surface_distances = compute_surface_distances(gt, predict, (1, 1, 1))
    dice = compute_dice_coefficient(gt, predict)
    hausdorff = compute_robust_hausdorff(surface_distances, 100)
    print(f'dice: {dice}, hausdorff: {hausdorff}')
