...
def export_data_features(series_uid, image_path, mask_path, out_path) -> Dict:
    ...
    if os.path.exists(mask_path):
        ...
        binary_index_scale = [float(binary_bbox[0, 1] - binary_bbox[0, 0] + 1),
                              float(binary_bbox[1, 1] - binary_bbox[1, 0] + 1),
                              float(binary_bbox[2, 1] - binary_bbox[2, 0] + 1)]
        ...
        res_dict['binary_index_scale'] = binary_index_scale
        res_dict['binary_physical_scale'] = binary_scale
...
if __name__ == '__main__':
    ...
    mask_dir = "/data/zhangfan/FLARE2022/raw_data/crop_labeled_mask/"
    out_dir = "/data/zhangfan/FLARE2022/preprocess_data/crop_feature/"
